...
#ifdef _MSC_VER
#pragma warning(disable : 4706) // DISABLE warning C4706: assignment within
...
OutputIterator copy_to_array(InputIterator first, InputIterator last,
                             OutputIterator result, size_t result_size)
{
#ifdef _MSC_VER
  stdext::checked_array_iterator<OutputIterator> checked_array(result,
                                                               result_size);
...
#define ALIGNED_ALLOC(p, sz, alignment)                                        \
  (p = (CHAR*)_aligned_malloc(sz, alignment))
...
FILE_OFFSET_TYPE file_handle_seek(FILE_HANDLE_TYPE, FILE_OFFSET_TYPE offset,
                                  int whence);
...
struct bitop<W, 8>
{
  ...
  {
    unsigned long v;
    return _BitScanForward(&v, (unsigned long)w) ?
               v :
...
{
  return bitop<W>::bsf(w &
                       ((from < (sizeof(W) << 3)) ? (~(W)0 << from) : (W)0));
}
...
struct Sys
{
  ...
  class Semaphore
  {
   ...
   public:
    ...
    {
      m_sem = ::CreateSemaphore(NULL, (std::numeric_limits<int>::max)(), count,
                                NULL);
    }
    ~Semaphore()
    {
...
struct NumData
{
  ...
  static ALIGN_DECL_DEFAULT DigitPair
      m_pairs[100]; /* string representations of "00" to "99" */
};
...
class UInt : public x86Data
{
 public:
...
#ifdef __GNUC__
#ifdef __x86_64__
    __asm__ __volatile__("bsrl %k0, %k0          \n\t"
                         "shlq $32, %q1          \n\t"
                         "movq (%2,%0,8), %0     \n\t"
                         "cmpq %0, %q1           \n\t"
                         "seta %b1               \n\t"
  ...
  static inline NOTHROW HEAVYUSE void generate(char* buf, uint32_t value,
                                               std::size_t len)
  {
    ...
    {
    default:
      u                     = (value * 1374389535ULL) >> 37;
      *(uint16_t*)(buf + 8) = m_pairs[value -= 100 * u].u;
    case 8:
      value                 = (u * 1374389535ULL) >> 37;
      *(uint16_t*)(buf + 6) = m_pairs[u -= 100 * value].u;
    case 6:
      u                     = (value * 1374389535ULL) >> 37;
      *(uint16_t*)(buf + 4) = m_pairs[value -= 100 * u].u;
    case 4:
      value                 = (u * 167773) >> 24;
      *(uint16_t*)(buf + 2) = m_pairs[u -= 100 * value].u;
    case 2:
      *(uint16_t*)(buf) = m_pairs[value].u;
    case 0:
      return;
    case 9:
      u                     = (value * 1374389535ULL) >> 37;
      *(uint16_t*)(buf + 7) = m_pairs[value -= 100 * u].u;
    case 7:
      value                 = (u * 1374389535ULL) >> 37;
      *(uint16_t*)(buf + 5) = m_pairs[u -= 100 * value].u;
    case 5:
      u                     = (value * 1374389535ULL) >> 37;
      *(uint16_t*)(buf + 3) = m_pairs[value -= 100 * u].u;
    case 3:
      value                 = (u * 167773) >> 24;
      *(uint16_t*)(buf + 1) = m_pairs[u -= 100 * value].u;
    case 1:
      *buf = value + 0x30;
    }
    ...
    default:
      u                        = (value * 1374389535ULL) >> 37;
      *(uint16_t*)(buffer + 8) = m_pairs[value - 100 * u].u;
    case 4:
      value                          = (u * 1374389535ULL) >> 37;
      *(uint16_t*)(buffer + 6 + odd) = m_pairs[u - 100 * value].u;
    case 3:
      u                              = (value * 1374389535ULL) >> 37;
      *(uint16_t*)(buffer + 4 + odd) = m_pairs[value - 100 * u].u;
    case 2:
      value                          = (u * 1374389535ULL) >> 37;
      *(uint16_t*)(buffer + 2 + odd) = m_pairs[u - 100 * value].u;
    case 1:
      u                  = (value * 6554) >> 16;
      *(uint16_t*)buffer = m_pairs[odd ? u : value].u;
      value -= 10 * u;
      len = -1;
    case 0:
      buffer[odd - len] = value + 0x30;
    }
#else
#if defined(__GNUC__) && defined(__x86_64__)
    uint16_t w;
    uint32_t u;
    __asm__ __volatile__("leaq T%=(%%rip), %q1           \n\t"
                         "addq (%q1,%3,8), %q1	  	  \n\t"
                         "jmp *%q1	                  \n\t"
                         "T%=: .quad L0%=-T%=        \n\t"
                         "     .quad L1%=-T%=        \n\t"
    ...
    {
    default:
      u                 = (value * 1441151881ULL) >> 57;
      *(uint16_t*)(buf) = m_pairs[u].u;
      value -= u * 100000000;
    case 8:
      u                           = (value * 1125899907ULL) >> 50;
      *(uint16_t*)(buf + len - 8) = m_pairs[u].u;
      value -= u * 1000000;
    case 6:
      u                           = (value * 429497ULL) >> 32;
      *(uint16_t*)(buf + len - 6) = m_pairs[u].u;
      value -= u * 10000;
    case 4:
      u                           = (value * 167773) >> 24;
      *(uint16_t*)(buf + len - 4) = m_pairs[u].u;
      value -= u * 100;
    case 2:
      *(uint16_t*)(buf + len - 2) = m_pairs[value].u;
    case 0:
      return;
    case 9:
      u                 = (value * 1801439851ULL) >> 54;
      *(uint16_t*)(buf) = m_pairs[u].u;
      value -= u * 10000000;
    case 7:
      u                           = (value * 43980466ULL) >> 42;
      *(uint16_t*)(buf + len - 7) = m_pairs[u].u;
      value -= u * 100000;
    case 5:
      u                           = (value * 268436ULL) >> 28;
      *(uint16_t*)(buf + len - 5) = m_pairs[u].u;
      value -= u * 1000;
    case 3:
      u                           = (value * 6554) >> 16;
      *(uint16_t*)(buf + len - 3) = m_pairs[u].u;
      value -= u * 10;
    case 1:
      *(buf + len - 1) = value + 0x30;
    }
#else
    uint32_t u;
    switch (len)
  ...
  // serializer that calculates length, buffer must have space for any value
  ...
  static inline unsigned NOTHROW HEAVYUSE generate(char* buf, uint32_t value)
  {
    ...
    if (x)
    {
      ...
      z = _mm_add_epi32(z, _mm_mul_epu32(_mm_cvtsi32_si128(mul_10000),
                                         _mm_srli_epi64(o, 45)));
    ...
    l += 1 + (x | (value != 0));
    *(uint32_t*)buf =
        0x30 + ((l > 1) ? ((0x30 + y - value * 10) << 8) + value : y);
    return l;
  }
...
#else // _M_IX86
    uint32_t v;
    log2 = _BitScanReverse((DWORD*)&v, (unsigned long)(log2 >> 32)) ?
               v + 32 :
...
{
  template <typename T>
  static inline void shift_up_from(T* src, std::size_t count)
  {
    if (LIKELY(count < 8))
      while (count)
      {
      ...
      ::memmove(src + 1, src, count * sizeof(T));
  }
  template <typename T>
  static inline void shift_down_to(T* src, std::size_t count)
  {
    if (LIKELY(count < 8))
      while (count--)
      {
      ...
      ::memmove(src, src + 1, count * sizeof(T));
  }
};
...
struct CharBuffer
{
  ...
  static inline int32_t PURE_DECL HEAVYUSE checkSum(const char* p, int size)
  {
    ...
    while (n > 0)
    {
      ...
      __asm__ __volatile__(" movzbl (%1), %%ecx; "
                           " addl %%ecx, %0;   "
                           : "+r"(x), "+r"(pu)
                           :
                           : "ecx");
  ...
  template <std::size_t S>
  static inline const char* find(const Fixed<S>& f, const char* p,
                                 std::size_t size)
  {
...
template <>
inline std::size_t PURE_DECL CharBuffer::find<8>(int v,
                                                 const CharBuffer::Fixed<8>& f)
{
  unsigned at = 0;
  __asm__ __volatile(
#if defined(__AVX__)
...
template <>
union CharBuffer::Fixed<15> {
  char data[15];

  inline bool set(const char* s, std::size_t len, std::size_t pos = 0,
                  std::size_t narrow = 1)
  {
...
#endif
{
  ...
  static inline void NOTHROW HEAVYUSE generate(char* buf, uint32_t x,
                                               int digits)
  {
#if defined(_MSC_VER) ||                                                       \
    (defined(__GNUC__) && (defined(__x86_64__) || defined(__i386__)))
    ...
    else
    {
      ...
      if (LIKELY(digits <= 4))
        ...
        *(uint64_t*)buf =
            packed; // can overwrite space reserved for '=', '\001' and '\000'
#else
 ...
 public:
  ...
  {
    inline std::size_t operator()(int tag) const
    {
      return tag;
    }
  };
  ...
  template <typename S>
  static void append(S& result, int value, int digits)
  {
  ...
  template <typename S>
  static void set(S& result, int value, int digits)
  {
    char buf[MaxValueSize];
    generate(buf, (uint32_t)value, digits);
  ...
  static inline const char NOTHROW_PRE* PURE_DECL HEAVYUSE NOTHROW_POST
  delimit(const char* p, unsigned len)
  {
#if defined(__GNUC__) && defined(__x86_64__)
    if (LIKELY(len > 1))
    {
  ...
  // store correct accumulated value even in case of a stop at a non-digit
  // character
  static inline bool HEAVYUSE NOTHROW parse(const char* b, const char* e,
                                            int& rv, int& rx)
  {
    bool valid = false;
    unsigned a, c, s = *b == '-';
...
class BitSet
{
  ...
  static const std::size_t word_shift =
      detail::log_<sizeof(word_type) * 8>::value;
...
template <>
class BitSet<sizeof(uint64_t) * 8>
{
...
struct int32_key_holder
{
  ...
  template <typename F>
  F* lookup_pos(uint32_t mask, F* m_p[Size + 1])
  {
    F* p = NULL;
  ...
  template <typename F>
  std::size_t insert_key(int32_t key, F* p, F* m_p[Size + 1])
  {
    uint32_t i = Size;
    __asm__ __volatile__(" bsf %1, %%edx;            \n\t"
                         " cmovnz %%edx, %0;         \n\t"
                         " btr %0, %1;               \n\t"
                         : "+r"(i), "+m"(m_mask)
                         :
  ...
  template <typename F>
  F* erase_pos(uint32_t mask, F* m_p[Size + 1])
  {
    int32_t tmp;
    F* p = NULL;
    __asm__ __volatile__(" bsf %0, %0;               \n\t"
                         " cmovnz (%4,%q0,8), %3;    \n\t"
                         " setnz %b1;                \n\t"
                         " movzbl %b1, %1;           \n\t"
                         " shl %b0, %1;              \n\t"
  ...
  template <typename F>
  F* evict_pos(std::size_t pos, F* m_p[Size + 1])
  {
    std::size_t tmp = Size;
    F* p            = NULL;
    __asm__ __volatile__(" bts %2, %0                \n\t"
                         " cmovc %4, %2              \n\t"
                         " cmp %2, %4                \n\t"
                         " cmovg (%3,%2,8), %1       \n\t"
                         : "+m"(m_mask), "+r"(p)
...
template <>
struct int32_keys<8> : public int32_key_holder<8>
{
...
template <>
struct int32_keys<16> : public int32_key_holder<16>
{
  inline uint32_t keymask(int32_t key)
  {
    uint32_t mask;
    __asm__ __volatile__(
        ...
        " and %1, %0;               \n\t"
        : "=r"(mask), "+r"(key)
        : "m"(m_simd[0]), "m"(m_simd[1]), "m"(m_simd[2]), "m"(m_simd[3]),
          "m"(m_mask)
...
class IntPtrCache : private int32_keys<N>
{
...
template <typename F>
class PtrCache<int32_t, F, 16> : public detail::IntPtrCache<F, 16>
{
};
template <typename F>
class PtrCache<int32_t, F, 8> : public detail::IntPtrCache<F, 8>
{
};
...
#define IOV_BUF_INITIALIZER(ptr, len)                                          \
  {                                                                            \
    (ULONG)(len), (CHAR*)(ptr)                                                 \
  }
...
#define IOV_LEN(b) ((b).len)
  ...
  static inline void NOTHROW append(sg_buf_t& buf, const char* s,
                                    std::size_t len)
  {
  ...
  static inline int64_t NOTHROW writev(FILE_HANDLE_TYPE handle, sg_buf_ptr bufs,
                                       int n)
  {
    int64_t sz = 0;
    for (int i = 0; i < n; i++)
    {
      DWORD written = 0;
      if (!::WriteFile(handle, IOV_BUF(bufs[i]), IOV_LEN(bufs[i]), &written,
                       NULL))
      {
        if (sz == 0)
          return -1;
                                    ...
                                    std::size_t len)
  {
    ...
    else if (LIKELY(len > 0))
    {
      ...
      else
      {
        ...
        _mm_storeu_si128((__m128i*)(p + len - 16),
                         _mm_loadu_si128((__m128i*)(s + len - 16)));
      }
    }
#else
    while (len--)
...
#ifdef _MSC_VER
#pragma warning(default : 4706) // RE-ENABLE warning C4706: assignment within
                                // conditional expression
#endif
