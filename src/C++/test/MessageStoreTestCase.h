...
#define CHECK_MESSAGE_STORE_SET_GET                         \
  ...
  CHECK_EQUAL( (std::size_t)3, messages.size() );           \
  ...
  CHECK_EQUAL( (std::size_t)0, messages.size() );           \
                                                            \
  object->get( 2, 6, messages );                            \
  CHECK_EQUAL( (std::size_t)2, messages.size() );           \
...
#define CHECK_MESSAGE_STORE_SET_GET_WITH_QUOTE        \
  ...
  CHECK_EQUAL( (std::size_t)4, messages.size() );     \
